...
})))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel')), '/application/src', array('/application/templates' => NULL, '/application/vendor/symfony/twig-bridge/Resources/views/Form' => NULL)));
